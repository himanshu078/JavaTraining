...
//		System.out.println("this one again - " + this.fname);
	...
	public  String firstAndLastName(String fname, String lname) {
		String fullName = fname + lname;
		System.out.println(fullName);
		return fullName;	
	}
	
	public  String fullNameWithMiddleName(String fname, String mname, String lname) {
		String fullName = fname + mname + lname;
		System.out.println(fullName);
		return fullName;	
	}
	
	public  String fullNameWithSuffix(String fname, String lname, String suffix) {
	...
	//	return getTeacherName();
		System.out.println("This method is in Students Details");
